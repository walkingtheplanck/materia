...
pub fn stone() -> MaterialDef {
    compile_as(&basalt_substance(), "stone", PhaseState::Solid)
}
pub fn granite() -> MaterialDef {
    compile_as(&granite_substance(), "granite", PhaseState::Solid)
}

// -- Loose materials (same substances, granular form) --

pub fn sand() -> MaterialDef {
    compile_as(&quartz_substance(), "sand", PhaseState::Granular)
}
pub fn clay() -> MaterialDef {
    compile_as(&clay_substance(), "clay", PhaseState::Granular)
}
pub fn dirt() -> MaterialDef {
    compile_as(&soil_substance(), "dirt", PhaseState::Granular)
}
pub fn gravel() -> MaterialDef {
    compile_as(&basalt_substance(), "gravel", PhaseState::Granular)
}
...
pub fn steel() -> MaterialDef {
    compile_as(
        &Substance::Crystalline(Crystal::steel(0.008)),
        "steel",
        PhaseState::Solid,
    )
}
pub fn copper() -> MaterialDef {
    compile_as(
...
pub fn gold() -> MaterialDef {
    compile_as(
        &Substance::Crystalline(Crystal::gold()),
        "gold",
        PhaseState::Solid,
    )
}
...
pub fn lava() -> MaterialDef {
    compile_as(&basalt_substance(), "lava", PhaseState::Liquid)
}
